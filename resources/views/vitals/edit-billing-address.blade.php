        ...
        <div class="row mt-5">
            ...
            <div class="col-md-5 border-right">
                {{-- BILLING ADDRESS FORM STARTS HERE --}}
                    <form action="{{ route('update.billing.address', $address->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="p-3 py-5">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3 mt-3">
                                <h4 class="text-right">Edit Billing Address</h4>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="first_name" class="form-control" placeholder="first name" value="{{ $address->first_name }}">
                                    @error('first_name')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="surname" class="form-control" value="{{ $address->surname }}" placeholder="surname">
                                    @error('surname')
                                        <small class="d-block text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="mobile_number" class="form-control" placeholder="enter phone number" value="{{ $address->mobile_number }}">
                                    @error('mobile_number')
                                        <small class="d-block text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="postal_code" class="form-control" placeholder="enter zip/postal code" value="{{ $address->postal_code }}">
                                    @error('postal_code')
                                        <small class="d-block text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="state" class="form-control" placeholder="enter state" value="{{ $address->state }}">
                                    @error('state')
                                        <small class="d-block text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="city" class="form-control" placeholder="enter city/town" value="{{ $address->city }}">
                                    @error('city')
                                        <small class="d-block text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="street_address" class="form-control" placeholder="enter street address" value="{{ $address->street_address }}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="country" class="form-control" placeholder="default(Nigeria)" value="{{ $address->country }}">
                                    @error('country')
                                        <small class="d-block text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            {{-- SUBMIT BUTTON --}}
                            <div class="mt-5 text-center"><button class="btn text-white profile-button" style="background-color: #2A2A2A !important" type="submit">Edit Billing Address</button></div>
                        </div>
