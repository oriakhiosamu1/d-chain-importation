            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Edit {{ $product->name }}</div>
                    </div>

                    {{-- FORM STARTS HERE --}}
                        <form action="{{ route('admin.edit-single-product', $product->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                ...
                                <div class="row px-3">
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        ...
                                        <input name="name" type="text" class="form-control input-pill" id="pillInput" placeholder="Name of product" value="{{ $product->name }}">
                                        @error('name')
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        ...
                                        <input name="price" type="text" class="form-control input-pill" id="pillInput" placeholder="Price of product" value="{{ $product->price }}">
                                        @error('price')
                                            <small class="d-block text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row px-3">
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        ...
                                        <input name="quantity" type="text" class="form-control input-pill" id="pillInput" placeholder="Quantity of product" value="{{ $product->quantity }}">
                                        @error('quantity')
                                            <small class="d-block text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        ...
                                        <select name="category" class="form-control input-pill">
                                            <option value= "{{ $product->category }}" class="text-center">{{ $product->category }}</option>
                            ...
                            <div class="mx-4 my-4">
                                ...
                                <textarea name="quote" id="quote">{!! $product->quote !!}</textarea>
                                @error('quote')
                                    <small class="d-block text-danger">{{ $message }}</small>
                                @enderror
                            </div>
